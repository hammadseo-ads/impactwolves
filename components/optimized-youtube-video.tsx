    ...
    <div className={`relative w-full aspect-video rounded-lg overflow-hidden cursor-pointer group ${className}`}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="text-center space-y-6 p-8">
          ...
          <Button
            onClick={handlePlay}
            className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white px-8 py-4 rounded-full transition-all duration-300 group-hover:scale-105"
          >
            <Play className="w-8 h-8 mr-3 fill-current" />
            <span className="text-lg font-semibold">Watch Tutorial</span>
          </Button>
        </div>
